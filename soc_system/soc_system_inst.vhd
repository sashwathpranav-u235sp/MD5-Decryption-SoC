	component soc_system is
		port (
			...
			md5_group_data_0_md5_group_data_md5_writeaddr   : out   std_logic_vector(8 downto 0);                     -- md5_writeaddr
			md5_group_data_0_md5_group_data_md5_readadder   : out   std_logic_vector(6 downto 0);                     -- md5_readadder
			md5_group_data_0_md5_group_data_md5_writedata   : out   std_logic_vector(31 downto 0);                    -- md5_writedata
			md5_group_data_0_md5_group_data_md5_readdata    : in    std_logic_vector(31 downto 0) := (others => 'X'); -- md5_readdata
